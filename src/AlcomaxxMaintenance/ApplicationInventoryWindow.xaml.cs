...
public partial class ApplicationInventoryWindow : Window
{
    ...
    public ApplicationInventoryWindow(JobState job, UsbWorkspace workspace)
    {
        ...
        StatusText.Text = job.SelectedApplications.Count > 0
            ? $"Trabajo reanudado: {job.SelectedApplications.Count} aplicaciones guardadas. Pulse Analizar para verificar el inventario."
            : "Pulse Analizar para consultar el registro y Microsoft Store.";
    }
